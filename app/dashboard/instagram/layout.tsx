...
const navGroups: NavGroup[] = [
  {
    label: 'Analytics',
    items: [
      { label: 'Visão Geral', href: '/dashboard/instagram', icon: LayoutDashboard },
      ...
      { label: 'Audiência', href: '/dashboard/instagram/audience', icon: Users },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Anúncios', href: '/dashboard/instagram/ads', icon: Megaphone },
      { label: 'Calendário', href: '/dashboard/instagram/calendar', icon: Calendar },
  ...
  },
  {
    label: 'Engajamento',
    items: [
      { label: 'Comentários', href: '/dashboard/instagram/comments', icon: MessageCircle },
...
const mobileNavItems: NavItem[] = [
  { label: 'Início', href: '/dashboard/instagram', icon: LayoutDashboard },
  { label: 'Posts', href: '/dashboard/instagram/posts', icon: ImageIcon },
  { label: 'Reels', href: '/dashboard/instagram/reels', icon: Film },
  { label: 'Stories', href: '/dashboard/instagram/stories', icon: Clock },
  { label: 'Crescimento', href: '/dashboard/instagram/growth', icon: TrendingUp },
